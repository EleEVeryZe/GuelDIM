                        ...
                        loading ? <div style={{ padding: '20px', fontFamily: 'sans-serif' }}>Carregando intenções de compra...</div> :
                            <>
                                    ...
                                    <div style={{ marginBottom: 30, padding: 20, border: '1px solid #28a745', borderRadius: 8, backgroundColor: '#f8fff9' }}>
                                        ...
                                        <form onSubmit={handleNovaIntencaoSubmit}>
                                            <div className="card-internal-grid" style={{ marginBottom: 10 }}>
                                                ...
                                                <Autocomplete
                                                    id="nome-produto-autocomplete-new"
                                                    freeSolo
                                                    options={intencoesOrdenadas.map((intencao) => intencao.produto.nome)}
                                                    value={novaIntencaoForm.nome || ""}
                                                    onChange={(event, newValue) => {
                                                        setNovaIntencaoForm({ ...novaIntencaoForm, nome: newValue || "" });
                                                    }}
                                                    onInputChange={(event, newInputValue) => {
                                                        setNovaIntencaoForm({ ...novaIntencaoForm, nome: newInputValue || "" });
                                                    }}
                                                    renderInput={(params) => (
                                                        <TextField
                                                            {...params}
                                ...
                                <div className="operations-grid">
                                    ...
                                    <div style={{ padding: 20, border: '1px solid #ddd', borderRadius: 8, backgroundColor: '#fff', boxSizing: 'border-box' }}>
                                        ...
                                        <form onSubmit={handleCotacaoSubmit}>
                                            ...
                                            <div style={{ marginBottom: 10 }}>
                                                <label>Contato Fornecedor(WhatsApp):</label>
                                                <input
                                            ...
                                            return (
                                                <li key={intencao.id} style={{
                                                    ...
                                                    <div className="card-header-flex">
                                                        <div>
                                                            <strong style={{ fontSize: '1.2em', color: '#333', cursor: "pointer" }} onClick={() => {
                                                                let stg = `
                                Descricao: ${intencao.produto.descricao}  
                                Marca: ${intencao.produto.marca}  
                                Modelo: ${intencao.produto.modelo}  
                                Observação: ${intencao.produto.observacao}  
                              ...
                              `;
                                                                       ...
                                                                       <a href={`https://wa.me/${c.contato}?text=${encodeURIComponent( `Olá! Tudo bem? Tenho interesse no produto abaixo: ━━━━━━━━━━━━━━━━━━━━ Produto: ${intencao.produto.nome} Modelo: ${intencao.produto.modelo} ━━━━━━━━━━━━━━━━━━━━ Poderia me informar: • Disponibilidade • Garantia • Prazo de envio • Melhor valor ${c.link ? ` ━━━━━━━━━━━━━━━━━━━━ Link do produto: ${c.link} ` : ''}Obrigado!` )}`} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: '#25D366', marginLeft: 10, fontWeight: 'bold' }} >WhatsApp </a> 
